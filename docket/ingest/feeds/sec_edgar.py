"""SEC EDGAR live feed watcher — the DE-first ingestion spine. Polls the daily filing index and yields new-document events (10-K/8-K) to
...
def watch_new_filings(forms: tuple[str, ...] = ("10-K", "8-K")) -> Iterator[dict]:
    ...
    raise NotImplementedError("EDGAR watcher not wired yet")
